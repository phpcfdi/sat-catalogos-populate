...
class PeriodicidadesPagosTest extends TestCase
{
    ...
    /** @var PeriodicidadesPagos */
    private $injector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('nomina/c_PeriodicidadPago.csv');
        $this->injector = new PeriodicidadesPagos($this->sourceFile);
    }

    public function testPeriodicidadesPagosExtendsAbstractCsvInjector(): void
    {
    ...
    public function testDataTableFields(): void
    {
        ...
        $this->assertSame('nomina_periodicidades_pagos', $dataTable->name());
        $expectedClasses = [
