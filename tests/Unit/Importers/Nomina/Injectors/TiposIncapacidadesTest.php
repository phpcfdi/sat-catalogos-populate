...
class TiposIncapacidadesTest extends TestCase
{
    ...
    /** @var TiposIncapacidades */
    private $injector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('nomina/c_TipoIncapacidad.csv');
        $this->injector = new TiposIncapacidades($this->sourceFile);
    }

    public function testTiposIncapacidadesExtendsAbstractCsvInjector(): void
    {
    ...
    public function testDataTableFields(): void
    {
        ...
        $this->assertSame('nomina_tipos_incapacidades', $dataTable->name());
        $expectedClasses = [
