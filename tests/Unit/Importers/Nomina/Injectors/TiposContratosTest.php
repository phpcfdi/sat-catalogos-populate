...
class TiposContratosTest extends TestCase
{
    ...
    private TiposContratos $injector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('nomina/c_TipoContrato.csv');
        $this->injector = new TiposContratos($this->sourceFile);
    }

    public function testTiposContratosExtendsAbstractCsvInjector(): void
    {
    ...
    public function testDataTableFields(): void
    {
        ...
        $this->assertSame('nomina_tipos_contratos', $dataTable->name());
        $expectedClasses = [
