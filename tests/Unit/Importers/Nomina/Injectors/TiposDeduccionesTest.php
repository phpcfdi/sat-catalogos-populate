...
class TiposDeduccionesTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('nomina/c_TipoDeduccion.csv');
        $this->injector = new TiposDeducciones($this->sourceFile);
    }

    public function testTiposDeduccionesExtendsAbstractCsvInjector(): void
    {
    ...
    public function testDataTableFields(): void
    {
        ...
        $this->assertSame('nomina_tipos_deducciones', $dataTable->name());
        $expectedClasses = [
