...
class TiposNominasTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('nomina/c_TipoNomina.csv');
        $this->injector = new TiposNominas($this->sourceFile);
    }

    public function testTiposNominasExtendsAbstractCsvInjector(): void
    {
    ...
    public function testDataTableFields(): void
    {
        ...
        $this->assertSame('nomina_tipos_nominas', $dataTable->name());
        $expectedClasses = [
