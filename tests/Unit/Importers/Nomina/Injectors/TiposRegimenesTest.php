...
class TiposRegimenesTest extends TestCase
{
    ...
    private \PhpCfdi\SatCatalogosPopulate\Importers\Nomina\Injectors\TiposRegimenes $injector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('nomina/c_TipoRegimen.csv');
        $this->injector = new TiposRegimenes($this->sourceFile);
    }

    public function testTiposRegimenesExtendsAbstractCsvInjector(): void
    {
    ...
    public function testDataTableFields(): void
    {
        ...
        $this->assertSame('nomina_tipos_regimenes', $dataTable->name());
        $expectedClasses = [
