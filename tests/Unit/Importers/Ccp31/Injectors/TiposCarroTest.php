...
use PhpCfdi\SatCatalogosPopulate\Importers\Ccp31\Injectors\TiposCarro;
...
class TiposCarroTest extends TestCase
{
    ...
    private TiposCarro $injector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ccp31/c_TipoCarro.csv');
        $this->injector = new TiposCarro($this->sourceFile);
    }
    ...
    public function testDataTable(): void
    {
        $this->checkDataTable(
            ...
            [
                ...
                'contenedor' => TextDataField::class,
