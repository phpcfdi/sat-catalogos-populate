...
use PhpCfdi\SatCatalogosPopulate\Importers\Ccp31\Injectors\ConfiguracionesAutotransporte;
...
class ConfiguracionesAutotransporteTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ccp31/c_ConfigAutotransporte.csv');
    ...
    public function testDataTable(): void
    {
        $this->checkDataTable(
            ...
            [
                ...
                'numero_de_ejes' => IntegerDataField::class,
                'numero_de_llantas' => IntegerDataField::class,
                'remolque' => TextDataField::class,
