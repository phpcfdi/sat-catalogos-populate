...
use PhpCfdi\SatCatalogosPopulate\Importers\Ccp31\Injectors\Contenedores;
...
class ContenedoresTest extends TestCase
{
    ...
    private Contenedores $injector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ccp31/c_Contenedor.csv');
        $this->injector = new Contenedores($this->sourceFile);
    }

    public function testContenedoresExtendsAbstractCsvInjector(): void
    {
