...
use PhpCfdi\SatCatalogosPopulate\Importers\Ret20\Injectors\EntidadesFederativas;
...
class EntidadesFederativasTest extends TestCase
{
    ...
    private EntidadesFederativas $injector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ret20/c_EntidadesFederativas.csv');
        $this->injector = new EntidadesFederativas($this->sourceFile);
    }

    public function testEntidadesFederativasExtendsAbstractCsvInjector(): void
    {
    ...
    public function testDataTable(): void
    {
        ...
        $this->assertSame('ret_20_entidades_federativas', $dataTable->name());
        $expectedClasses = [
