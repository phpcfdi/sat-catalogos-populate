...
use PhpCfdi\SatCatalogosPopulate\Importers\Ret20\Injectors\TiposContribuyentes;
...
class TiposContribuyentesTest extends TestCase
{
    ...
    private TiposContribuyentes $injector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ret20/c_TipoContribuyenteSujetoRetenc.csv');
        $this->injector = new TiposContribuyentes($this->sourceFile);
    }

    public function testTiposContribuyentesExtendsAbstractCsvInjector(): void
    {
    ...
    public function testDataTable(): void
    {
        ...
        $this->assertSame('ret_20_tipos_contribuyentes', $dataTable->name());
        $expectedClasses = [
