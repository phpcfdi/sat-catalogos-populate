...
use PhpCfdi\SatCatalogosPopulate\Importers\Ret20\Injectors\TiposPagoRetencion;
...
class TiposPagoRetencionTest extends TestCase
{
    ...
    private TiposPagoRetencion $injector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ret20/c_TipoPagoRet.csv');
        $this->injector = new TiposPagoRetencion($this->sourceFile);
    }

    public function testTiposPagoRetencionExtendsAbstractCsvInjector(): void
    {
    ...
    public function testDataTable(): void
    {
        ...
        $this->assertSame('ret_20_tipos_pago_retencion', $dataTable->name());
        $expectedClasses = [
            'id' => PaddingDataField::class,
            'texto' => TextDataField::class,
            'tipo_impuesto' => PaddingDataField::class,
