...
use PhpCfdi\SatCatalogosPopulate\Importers\Ret20\Injectors\TiposDividendosUtilidades;
...
class TiposDividendosUtilidadesTest extends TestCase
{
    ...
    private TiposDividendosUtilidades $injector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ret20/c_TipoDividendoOUtilidadDistrib.csv');
        $this->injector = new TiposDividendosUtilidades($this->sourceFile);
    }

    public function testTiposDividendosExtendsAbstractCsvInjector(): void
    {
    ...
    public function testDataTable(): void
    {
        ...
        $this->assertSame('ret_20_tipos_dividendos_utilidades', $dataTable->name());
        $expectedClasses = [
