...
use PhpCfdi\SatCatalogosPopulate\Importers\Ret20\Injectors\ClavesRetencion;
...
class ClavesRetencionTest extends TestCase
{
    ...
    private ClavesRetencion $injector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ret20/c_CveRetenc.csv');
        $this->injector = new ClavesRetencion($this->sourceFile);
    }
    ...
    public function testDataTable(): void
    {
        ...
        $this->assertSame('ret_20_claves_retencion', $dataTable->name());
        $expectedClasses = [
            'id' => PaddingDataField::class,
            'texto' => TextDataField::class,
            'nombre_complemento' => TextDataField::class,
