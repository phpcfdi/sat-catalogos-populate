...
use PhpCfdi\SatCatalogosPopulate\Importers\Ret20\Injectors\TiposImpuestos;
...
class TiposImpuestosTest extends TestCase
{
    ...
    private TiposImpuestos $injector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ret20/c_TipoImpuesto.csv');
        $this->injector = new TiposImpuestos($this->sourceFile);
    }

    public function testTiposImpuestosExtendsAbstractCsvInjector(): void
    {
    ...
    public function testDataTable(): void
    {
        ...
        $this->assertSame('ret_20_tipos_impuestos', $dataTable->name());
        $expectedClasses = [
