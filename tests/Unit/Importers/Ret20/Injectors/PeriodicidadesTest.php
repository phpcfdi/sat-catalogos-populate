...
use PhpCfdi\SatCatalogosPopulate\Importers\Ret20\Injectors\Periodicidades;
...
class PeriodicidadesTest extends TestCase
{
    ...
    private Periodicidades $injector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ret20/c_Periodicidad.csv');
        $this->injector = new Periodicidades($this->sourceFile);
    }

    public function testPeriodicidadesExtendsAbstractCsvInjector(): void
    {
    ...
    public function testDataTable(): void
    {
        ...
        $this->assertSame('ret_20_periodicidades', $dataTable->name());
        $expectedClasses = [
