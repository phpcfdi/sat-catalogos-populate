...
use PhpCfdi\SatCatalogosPopulate\Importers\Ret20\Injectors\Periodos;
...
class PeriodosTest extends TestCase
{
    ...
    private Periodos $injector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ret20/c_Periodo.csv');
        $this->injector = new Periodos($this->sourceFile);
    }

    public function testPeriodosExtendsAbstractCsvInjector(): void
    {
    ...
    public function testDataTable(): void
    {
        ...
        $this->assertSame('ret_20_periodos', $dataTable->name());
        $expectedClasses = [
