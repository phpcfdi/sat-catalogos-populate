...
use PhpCfdi\SatCatalogosPopulate\Importers\Ret20\Injectors\Paises;
...
class PaisesTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ret20/c_Pais.csv');
    ...
    public function testDataTable(): void
    {
        ...
        $this->assertSame('ret_20_paises', $dataTable->name());
        $expectedClasses = [
