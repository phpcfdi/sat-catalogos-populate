...
use PhpCfdi\SatCatalogosPopulate\Importers\HidroPretro10\Injectors\ClavesHyp;
...
final class ClavesHypTest extends TestCase
{
    private string $sourceFile;

    private ClavesHyp $injector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('hidropetro10/c_ClaveHYP.csv');
        $this->injector = new ClavesHyp($this->sourceFile);
    }
    ...
    public function testDataTable(): void
    {
        ...
        $this->assertSame('hyp_10_claves_hyp', $dataTable->name());
        $expectedClasses = [
            'id' => TextDataField::class,
            'descripcion' => TextDataField::class,
            'clave_unidad' => TextDataField::class,
            'subproductos' => TextDataField::class,
