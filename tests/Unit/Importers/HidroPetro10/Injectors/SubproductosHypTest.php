...
namespace PhpCfdi\SatCatalogosPopulate\Tests\Unit\Importers\HidroPetro10\Injectors;

use PhpCfdi\SatCatalogosPopulate\AbstractCsvInjector;
use PhpCfdi\SatCatalogosPopulate\Database\DateDataField;
use PhpCfdi\SatCatalogosPopulate\Database\TextDataField;
use PhpCfdi\SatCatalogosPopulate\Database\UsePreviousIfEmptyDataField;
use PhpCfdi\SatCatalogosPopulate\Importers\HidroPretro10\Injectors\SubproductosHyp;
...
final class SubproductosHypTest extends TestCase
{
    private string $sourceFile;

    private SubproductosHyp $injector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('hidropetro10/c_SubProductoHYP.csv');
        $this->injector = new SubproductosHyp($this->sourceFile);
    }

    public function testClavesRetencionExtendsAbstractCsvInjector(): void
    {
    ...
    public function testDataTable(): void
    {
        ...
        $this->assertSame('hyp_10_subproductos_hyp', $dataTable->name());
        $expectedClasses = [
            'id' => TextDataField::class,
            'descripcion' => TextDataField::class,
            'categoria' => UsePreviousIfEmptyDataField::class,
