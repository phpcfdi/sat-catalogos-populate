...
use PhpCfdi\SatCatalogosPopulate\Importers\HidroPretro10\Injectors\TiposPermiso;
...
final class TiposPermisoTest extends TestCase
{
    ...
    private TiposPermiso $injector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('hidropetro10/c_TipoPermiso.csv');
        $this->injector = new TiposPermiso($this->sourceFile);
    }
    ...
    public function testDataTable(): void
    {
        ...
        $this->assertSame('hyp_10_tipos_permisos', $dataTable->name());
        $expectedClasses = [
            'id' => TextDataField::class,
            'descripcion' => TextDataField::class,
            'nomenclatura' => TextDataField::class,
            'patron' => TextDataField::class,
