...
use PhpCfdi\SatCatalogosPopulate\Importers\Ccp30\Injectors\FormasFarmaceuticas;
...
class FormasFarmaceuticasTest extends TestCase
{
    ...
    private FormasFarmaceuticas $injector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ccp30/c_FormaFarmaceutica.csv');
        $this->injector = new FormasFarmaceuticas($this->sourceFile);
    }
