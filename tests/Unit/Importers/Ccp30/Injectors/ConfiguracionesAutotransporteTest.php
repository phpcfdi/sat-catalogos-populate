...
use PhpCfdi\SatCatalogosPopulate\Importers\Ccp30\Injectors\ConfiguracionesAutotransporte;
...
class ConfiguracionesAutotransporteTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ccp30/c_ConfigAutotransporte.csv');
