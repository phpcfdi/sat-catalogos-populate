...
use PhpCfdi\SatCatalogosPopulate\Importers\Ccp30\Injectors\CodigosTransporteAereo;
...
class CodigosTransporteAereoTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ccp30/c_CodigoTransporteAereo.csv');
    ...
    public function testDataTable(): void
    {
        $this->checkDataTable(
            ...
            [
                ...
                'designador_oaci' => TextDataField::class,
