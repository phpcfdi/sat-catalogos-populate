...
use PhpCfdi\SatCatalogosPopulate\Importers\Ccp30\Injectors\DocumentosAduaneros;
...
class DocumentosAduanerosTest extends TestCase
{
    ...
    private DocumentosAduaneros $injector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ccp30/c_DocumentoAduanero.csv');
        $this->injector = new DocumentosAduaneros($this->sourceFile);
    }
