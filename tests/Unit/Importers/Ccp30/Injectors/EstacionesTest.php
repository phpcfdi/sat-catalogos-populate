...
use PhpCfdi\SatCatalogosPopulate\Importers\Ccp30\Injectors\Estaciones;
...
class EstacionesTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ccp30/c_Estaciones.csv');
    ...
    public function testDataTable(): void
    {
        $this->checkDataTable(
            ...
            [
                ...
                'nacionalidad' => TextDataField::class,
                'designador_iata' => TextDataField::class,
                'linea_ferrea' => TextDataField::class,
