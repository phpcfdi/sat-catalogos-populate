...
use PhpCfdi\SatCatalogosPopulate\Importers\Ccp30\Injectors\RegistrosIstmo;
...
class RegistrosIstmoTest extends TestCase
{
    ...
    private RegistrosIstmo $injector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ccp30/c_RegistroISTMO.csv');
        $this->injector = new RegistrosIstmo($this->sourceFile);
    }
