...
use PhpCfdi\SatCatalogosPopulate\Importers\Ccp30\Injectors\RegimenesAduaneros;
...
class RegimenesAduanerosTest extends TestCase
{
    ...
    private RegimenesAduaneros $injector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ccp30/c_RegimenAduanero.csv');
        $this->injector = new RegimenesAduaneros($this->sourceFile);
    }
