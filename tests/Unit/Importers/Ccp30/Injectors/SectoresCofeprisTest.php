...
use PhpCfdi\SatCatalogosPopulate\Importers\Ccp30\Injectors\SectoresCofepris;
...
class SectoresCofeprisTest extends TestCase
{
    ...
    private SectoresCofepris $injector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ccp30/c_SectorCOFEPRIS.csv');
        $this->injector = new SectoresCofepris($this->sourceFile);
    }

    public function testSectoresCofeprisExtendsAbstractCsvInjector(): void
    {
