...
use PhpCfdi\SatCatalogosPopulate\Importers\Ccp20\Injectors\PartesTransporte;
...
class PartesTransporteTest extends TestCase
{
    ...
    private PartesTransporte $injector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ccp20/c_ParteTransporte.csv');
        $this->injector = new PartesTransporte($this->sourceFile);
    }

    public function testPartesTransporteExtendsAbstractCsvInjector(): void
    {
