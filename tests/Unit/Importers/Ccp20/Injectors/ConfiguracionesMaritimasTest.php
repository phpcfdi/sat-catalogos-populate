...
use PhpCfdi\SatCatalogosPopulate\Importers\Ccp20\Injectors\ConfiguracionesMaritimas;
...
class ConfiguracionesMaritimasTest extends TestCase
{
    ...
    private ConfiguracionesMaritimas $injector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ccp20/c_ConfigMaritima.csv');
        $this->injector = new ConfiguracionesMaritimas($this->sourceFile);
    }

    public function testConfiguracionesMaritimasExtendsAbstractCsvInjector(): void
    {
    ...
    public function testDataTable(): void
    {
        ...
        $this->assertSame('ccp_20_configuraciones_maritimas', $dataTable->name());
        $this->assertSame(
