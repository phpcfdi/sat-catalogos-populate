...
use PhpCfdi\SatCatalogosPopulate\Importers\Ccp20\Injectors\TiposServicio;
...
class TiposServicioTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ccp20/c_TipoDeServicio.csv');
    ...
    public function testDataTable(): void
    {
        ...
        $this->assertSame('ccp_20_tipos_servicio', $dataTable->name());
        $expectedClasses = [
