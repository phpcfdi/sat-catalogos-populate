...
use PhpCfdi\SatCatalogosPopulate\Importers\Ccp20\Injectors\ConfiguracionesAutotransporte;
...
class ConfiguracionesAutotransporteTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ccp20/c_ConfigAutotransporte.csv');
