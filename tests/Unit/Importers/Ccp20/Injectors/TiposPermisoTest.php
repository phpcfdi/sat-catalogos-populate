...
use PhpCfdi\SatCatalogosPopulate\Importers\Ccp20\Injectors\TiposPermiso;
...
class TiposPermisoTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ccp20/c_TipoPermiso.csv');
        $this->injector = new TiposPermiso($this->sourceFile);
    }

    public function testTiposPermisoExtendsAbstractCsvInjector(): void
    {
    ...
    public function testDataTable(): void
    {
        ...
        $this->assertSame('ccp_20_tipos_permiso', $dataTable->name());
        $this->assertSame(
            ['id', 'texto', 'clave_transporte', 'vigencia_desde', 'vigencia_hasta'],
