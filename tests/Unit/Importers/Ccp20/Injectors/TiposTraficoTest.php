...
use PhpCfdi\SatCatalogosPopulate\Importers\Ccp20\Injectors\TiposTrafico;
...
class TiposTraficoTest extends TestCase
{
    ...
    private TiposTrafico $injector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ccp20/c_TipoDeTrafico.csv');
        $this->injector = new TiposTrafico($this->sourceFile);
    }

    public function testTiposTraficoExtendsAbstractCsvInjector(): void
    {
    ...
    public function testDataTable(): void
    {
        ...
        $this->assertSame('ccp_20_tipos_trafico', $dataTable->name());
        $expectedClasses = [
