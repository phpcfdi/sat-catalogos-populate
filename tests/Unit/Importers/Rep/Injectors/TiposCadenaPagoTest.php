...
namespace PhpCfdi\SatCatalogosPopulate\Tests\Unit\Importers\Rep\Injectors;
...
class TiposCadenaPagoTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('rep/c_TIpoCadenaPago.csv');
        $this->injector = new TiposCadenaPago($this->sourceFile);
    }
    ...
    public function testDataTableFields(): void
    {
        ...
        $this->assertSame('pagos_tipos_cadena_pago', $dataTable->name());
        $expectedClasses = [
