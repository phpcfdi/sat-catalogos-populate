...
use PhpCfdi\SatCatalogosPopulate\Importers\Ccp\Injectors\TiposCarga;
...
class TiposCargaTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ccp/c_ClaveTipoCarga.csv');
    ...
    public function testDataTable(): void
    {
        ...
        $this->assertSame('ccp_tipos_carga', $dataTable->name());
        $this->assertSame(
