...
use PhpCfdi\SatCatalogosPopulate\Importers\Ccp\Injectors\TiposEstacion;
...
class TiposEstacionTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ccp/c_TipoEstacion.csv');
    ...
    public function testDataTable(): void
    {
        ...
        $this->assertSame('ccp_tipos_estacion', $dataTable->name());
        $this->assertSame(
