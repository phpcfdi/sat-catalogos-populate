...
use PhpCfdi\SatCatalogosPopulate\Importers\Ccp\Injectors\ClavesUnidades;
...
class ClavesUnidadesTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ccp/c_ClaveUnidadPeso.csv');
    ...
    public function testDataTable(): void
    {
        ...
        $this->assertSame(
            [
                ...
                'nota', 'vigencia_desde', 'vigencia_hasta',
                'simbolo', 'bandera',
            ],
