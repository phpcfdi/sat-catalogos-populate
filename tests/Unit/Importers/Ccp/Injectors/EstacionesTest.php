...
use PhpCfdi\SatCatalogosPopulate\Importers\Ccp\Injectors\Estaciones;
...
class EstacionesTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('ccp/c_Estaciones.csv');
    ...
    public function testDataTable(): void
    {
        ...
        $this->assertSame('ccp_estaciones', $dataTable->name());
        $this->assertSame(
            [
