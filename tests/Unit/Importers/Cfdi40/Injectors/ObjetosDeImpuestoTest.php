...
class ObjetosDeImpuestoTest extends TestCase
{
    ...
    private ObjetosDeImpuestos $injector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('cfdi40/c_ObjetoImp.csv');
        $this->injector = new ObjetosDeImpuestos($this->sourceFile);
    }

    public function testObjetosDeImpuestoExtendsAbstractCsvInjector(): void
    {
    ...
    public function testDataTableFields(): void
    {
        ...
        $this->assertSame('cfdi_40_objetos_impuestos', $dataTable->name());
        $expectedClasses = [
