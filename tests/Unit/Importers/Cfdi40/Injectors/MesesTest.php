...
class MesesTest extends TestCase
{
    ...
    private Meses $injector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('cfdi40/c_Meses.csv');
        $this->injector = new Meses($this->sourceFile);
    }

    public function testMesesExtendsAbstractCsvInjector(): void
    {
    ...
    public function testDataTableFields(): void
    {
        ...
        $this->assertSame('cfdi_40_meses', $dataTable->name());
        $expectedClasses = [
