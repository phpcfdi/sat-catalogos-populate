...
class ExportacionesTest extends TestCase
{
    ...
    private Exportaciones $injector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('cfdi40/c_Exportacion.csv');
        $this->injector = new Exportaciones($this->sourceFile);
    }

    public function testExportacionesExtendsAbstractCsvInjector(): void
    {
    ...
    public function testDataTableFields(): void
    {
        ...
        $this->assertSame('cfdi_40_exportaciones', $dataTable->name());
        $expectedClasses = [
