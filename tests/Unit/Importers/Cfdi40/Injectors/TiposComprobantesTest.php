...
class TiposComprobantesTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('cfdi40/c_TipoDeComprobante.csv');
        $this->injector = new TiposComprobantes($this->sourceFile);
    }

    public function testTiposComprobantesExtendsAbstractCsvInjector(): void
    {
    ...
    public function testDataTableFields(): void
    {
        ...
        $this->assertSame('cfdi_40_tipos_comprobantes', $dataTable->name());
        $expectedClasses = [
