...
class UnidadesAduanaTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->sourceFile = $this->utilFilePath('cce/c_UnidadAduana.csv');
        $this->injector = new UnidadesAduana($this->sourceFile);
    }

    public function testUnidadesAduanaExtendsAbstractCsvInjector(): void
    {
    ...
    public function testDataTableFields(): void
    {
        ...
        $this->assertSame('cce_unidades_medida', $dataTable->name());
        $expectedClasses = [
